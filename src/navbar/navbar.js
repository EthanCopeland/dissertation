        ...
        return (
            <div id="nav-box">
                <ul id="navbar" className="pure-u-1-3">
                    ...
                    <li><a className={this.props.page === "products" ? "active" : ""} href="/"><i className="fal fa-shopping-basket"></i> Products</a></li>
                    <li><a className={this.props.page === "about" ? "active" : ""} href="/"><i className="far fa-question-circle"></i> About Us</a></li>
